...
export const SidebarProvider = ({
  ...
  return (
    <SidebarContext.Provider value={{ open, setOpen, animate, lockOpen }}>
      {children}
...
export const Sidebar = ({
  ...
  return (
    <SidebarProvider open={open} setOpen={setOpen} animate={animate} lockOpen={lockOpen}>
      {children}
    </SidebarProvider>
  );
};
...
export const DesktopSidebar = ({
  ...
  const { open, setOpen, animate, lockOpen } = useSidebar();
  return (
    <motion.div
      className={cn(
